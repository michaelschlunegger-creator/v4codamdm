    ...
    "personas": [
      {
        ...
        "shortDescription": "Needs confidence that plant data is trustworthy so cash is not frozen in duplicate or misclassified materials.",
        "focusAreas": [
          "Working capital locked in redundant stock",
          "Visibility across sites and systems",
          "Confidence to fund rapid pilots"
        ],
        "redPath": "Link duplicates to cash release, quantify the pilot impact, and secure an executive sponsor for the PoC.",
        "questions": [
          {
            "id": "ceo-cfo-1",
          ...
          {
            "id": "ceo-cfo-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Working capital locked in redundant stock?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
            ],
            "bestOptionIndex": 0,
            "feedback": {
              "best": "Great—anchor the PoC on measurable outcomes and make scaling obvious.",
              "weak": "Stories help, but we should tie them to a KPI and a clear success threshold.",
              "bad": "Activity without evidence risks credibility. Keep the PoC laser-focused on proof."
            }
          },
          {
            "id": "ceo-cfo-5",
            "text": "Who must be involved and which data sources stay in scope so the PoC is credible and unblockable?",
            "options": [
              "Include the master data systems that matter most with finance/operations owners in a weekly steerco.",
              "Start with a narrow sample and add systems or stakeholders later if it goes well.",
              "Keep it informal with minimal stakeholders to move fast and avoid red tape."
            ],
            "bestOptionIndex": 0,
            "feedback": {
              "best": "Strong plan—governed data and accountable sponsors keep the PoC credible and quick.",
              "weak": "A narrow start can work if we lock the right systems and sponsors early.",
              "bad": "Lightweight is risky. A PoC without the right data or owners will stall."
            }
          }
        ]
      },
      {
        ...
        "shortDescription": "Focuses on working-capital release and auditable data that keeps reconciliations clean across subsidiaries.",
        "focusAreas": [
          "Consolidated visibility across ERPs",
          "Working-capital unlocks tied to data quality",
          "Governance that stands up to audit"
        ],
        "redPath": "Quantify leakage from misclassified spend, model the cash unlocked by cleansing, and propose a governance-led pilot.",
        "questions": [
          {
            "id": "fin-cfo-1",
          ...
          {
            "id": "fin-cfo-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Consolidated visibility across ERPs?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Balances SAP/Maximo governance with scalable integrations that prevent duplicate masters across systems.",
        "focusAreas": [
          "Cross-system master data flow",
          "Governance ownership and approval paths",
          "Proof that data quality improves reliability"
        ],
        "redPath": "Map the system landscape, agree on ownership, and show how CODA deduplicates across SAP, Maximo, and CMMS feeds.",
        "questions": [
          {
            "id": "cio-1",
          ...
          {
            "id": "cio-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Cross-system master data flow?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs accurate materials and vendor data so crews can execute safely without delays or excess buffers.",
        "focusAreas": [
          "First-time-right job execution",
          "BOM integrity across sites",
          "Safety stock calibrated to real specs"
        ],
        "redPath": "Connect misaligned descriptions to downtime risk, then show CODA keeping BOMs synchronized and buffers lean.",
        "questions": [
          {
            "id": "ops-1",
          ...
          {
            "id": "ops-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves First-time-right job execution?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Wants trusted data so outages aren't extended by wrong picks, missing parts, or reliance on one expert.",
        "focusAreas": [
          "Uptime and schedule adherence",
          "Reducing reliance on tribal knowledge",
          "Confidence in stock availability"
        ],
        "redPath": "Tie master-data reliability to downtime avoidance, then show CODA reducing dependency on a few veterans.",
        "questions": [
          {
            "id": "plant-1",
          ...
          {
            "id": "plant-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Uptime and schedule adherence?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs BOMs and asset registers to stay synchronized so failures aren't caused by wrong specs or missing lineage.",
        "focusAreas": [
          "Centralized and consistent asset data",
          "BOM accuracy and revision control",
          "Reducing failure risk from spec mismatch"
        ],
        "redPath": "Start with data standardization across sites, then offer a focused validation on a critical asset class.",
        "questions": [
          {
            "id": "eng-1",
          ...
          {
            "id": "eng-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Centralized and consistent asset data?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs clean, deduplicated stock data so bins are trusted, slow movers shrink, and audits stay clean.",
        "focusAreas": [
          "Cycle-count accuracy and audit readiness",
          "Duplicate detection across bins and sites",
          "Reducing slow movers and excess stock"
        ],
        "redPath": "Quantify duplicate and non-moving stock, then prove CODA keeps receipts, barcodes, and descriptions aligned.",
        "questions": [
          {
            "id": "wh-1",
          ...
          {
            "id": "wh-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Cycle-count accuracy and audit readiness?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs standardized specs to negotiate confidently, avoid maverick spend, and enable supplier consolidation.",
        "focusAreas": [
          "Duplicate prevention during sourcing",
          "Speed to RFQ with complete specs",
          "Supplier consolidation based on normalized spend"
        ],
        "redPath": "Anchor on savings leakage from duplicates, then show CODA accelerating intake and enabling supplier rationalization.",
        "questions": [
          {
            "id": "proc-1",
          ...
          {
            "id": "proc-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Duplicate prevention during sourcing?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Wants harmonized supplier and material data so price comparisons are fair and savings are defensible.",
        "focusAreas": [
        ...
        "redPath": "Uncover fragmented supplier pricing, then use CODA to normalize specs and expose consolidation opportunities.",
        "questions": [
          {
            "id": "cat-1",
          ...
          {
            "id": "cat-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Price variance across sites for identical items?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Links digital success to standardized master data so initiatives do not stall from inconsistent records.",
        "focusAreas": [
        ...
        "redPath": "Connect failed digital projects to data quality, then propose a readiness check on a high-visibility use case.",
        "questions": [
          {
            "id": "dig-1",
          ...
          {
            "id": "dig-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Data readiness for digital and automation use cases?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
    ...
    "personas": [
      {
        ...
        "shortDescription": "Needs defensible data for rate cases and capital plans while keeping inventory lean across depots.",
        "focusAreas": [
          "Evidence for regulatory filings",
          "Working-capital release without reliability risk",
          "Cross-site consistency for audits"
        ],
        "redPath": "Tie duplicate materials to rate impacts, prove how CODA maintains auditable masters, and scope a pilot on a critical asset class.",
        "questions": [
          {
            "id": "util-exec-1",
          ...
          {
            "id": "util-exec-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Evidence for regulatory filings?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs accurate materials and configurations so field crews install the right components the first time.",
        "focusAreas": [
          "First-time-right dispatch",
          "Storm stock accuracy",
          "Work package clarity"
        ],
        "redPath": "Link bad descriptions to truck-roll risk, then show CODA keeping BOMs and compatible parts aligned across depots.",
        "questions": [
          {
            "id": "grid-1",
          ...
          {
            "id": "grid-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves First-time-right dispatch?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Wants standardized specs to consolidate suppliers, speed RFQs, and avoid maverick spend during outages.",
        "focusAreas": [
          "Duplicate prevention in sourcing",
          "Faster RFQs with complete specs",
          "Supplier consolidation by normalized spend"
        ],
        "redPath": "Quantify savings leakage from duplicates and show CODA accelerating emergency and planned sourcing with clean specs.",
        "questions": [
          {
            "id": "util-scm-1",
          ...
          {
            "id": "util-scm-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Duplicate prevention in sourcing?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs BOMs and asset registers synchronized so failures aren’t caused by mismatched specs or lineage gaps.",
        "focusAreas": [
          "Centralized asset standards",
          "BOM accuracy and revision control",
          "Failure risk reduction"
        ],
        "redPath": "Start with data standardization across regions, then validate a critical asset class with CODA’s recommendations.",
        "questions": [
          {
            "id": "util-eng-1",
          ...
          {
            "id": "util-eng-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Centralized asset standards?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Links digital success to standardized master data so initiatives don’t stall from inconsistent records.",
        "focusAreas": [
          "Data readiness for automation/AMI",
          "Reliable master data powering analytics",
          "Change adoption across districts"
        ],
        "redPath": "Show how CODA cleanses data to unblock automation releases, then co-design a proof for a priority program.",
        "questions": [
          {
            "id": "util-dig-1",
          ...
          {
            "id": "util-dig-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Data readiness for automation/AMI?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
    ...
    "personas": [
      {
        ...
        "shortDescription": "Needs trustworthy data to cut working capital while keeping production schedules predictable.",
        "focusAreas": [
          "Working-capital release",
          "Schedule adherence",
          "Cross-plant visibility"
        ],
        "redPath": "Quantify duplicate-driven cash leakage, link cleansed masters to schedule adherence, and propose a pilot on a flagship line.",
        "questions": [
          {
            "id": "mfg-exec-1",
          ...
          {
            "id": "mfg-exec-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Working-capital release?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs trusted BOMs and stock data so outages aren’t extended by wrong picks or missing parts.",
        "focusAreas": [
          "Uptime and schedule adherence",
          "Reducing reliance on tribal knowledge",
          "Confidence in stock availability"
      ...
      },
      {
        ...
        "shortDescription": "Needs harmonized specs and BOMs so variants stay controlled and recalls are traceable.",
        "focusAreas": [
          "BOM integrity and revision control",
          "Spec harmonization across variants",
          "Traceability for audits"
        ],
        "redPath": "Map inconsistent specs to quality risk, then show CODA enforcing harmonization and lineage across lines.",
        "questions": [
          {
            "id": "mfg-qual-1",
          ...
          {
            "id": "mfg-qual-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves BOM integrity and revision control?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "redPath": "Show how CODA cleanses and standardizes data to unblock digital initiatives, then co-design a proof for a priority line.",
        "questions": [
          {
            "id": "mfg-dig-1",
          ...
          {
            "id": "mfg-dig-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Reliable master data powering analytics?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
    ...
    "personas": [
      {
        ...
        "shortDescription": "Needs standardized masters so EHR, ERP, and clinical systems agree, avoiding safety and reporting risk.",
        "focusAreas": [
        ...
        "redPath": "Link clean masters to patient safety, report accuracy, and evidence for digital health programs; propose a governed pilot on a high-volume service line.",
        "questions": [
          {
            "id": "hc-cdo-1",
          ...
          {
            "id": "hc-cdo-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Interoperability across EHR, ERP, and lab systems?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Wants consistent item masters and vendor data to negotiate confidently and prevent stockouts for clinicians.",
        "focusAreas": [
          "Contract compliance and formulary control",
          "Avoiding duplicates and substitutions",
          "Trusted availability for clinicians"
        ],
        "redPath": "Connect clean masters to contract compliance and surgeon satisfaction, then propose a pilot on a priority category (implants, lab reagents).",
        "questions": [
          {
            "id": "hc-supply-1",
          ...
          {
            "id": "hc-supply-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Contract compliance and formulary control?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs accurate asset and part data so maintenance is first-time-right and recalls are handled fast.",
        "focusAreas": [
          "Recall readiness and traceability",
          "BOM integrity for medical devices",
          "Reducing downtime in critical areas"
        ],
        "redPath": "Tie normalized asset and part data to recall response and uptime, then pilot on a high-risk device family.",
        "questions": [
          {
            "id": "hc-eng-1",
          ...
          {
            "id": "hc-eng-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Recall readiness and traceability?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs evidence that masters are governed so audits, UDI, and safety reporting are reliable.",
        "focusAreas": [
          "Audit-ready lineage and approvals",
          "UDI/IFU alignment across systems",
          "Reducing manual reconciliations"
        ],
        "redPath": "Show how CODA enforces attributes and traceability for UDI and safety reporting, then co-design an audit pack pilot.",
        "questions": [
          {
            "id": "hc-quality-1",
          ...
          {
            "id": "hc-quality-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Audit-ready lineage and approvals?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Links digital success to standardized master data so new programs aren’t blocked by inconsistent records.",
        "focusAreas": [
          "Data readiness for AI/analytics",
          "Adoption by clinicians and operations",
          "Reliable integrations across platforms"
        ],
        "redPath": "Show CODA as the quickest way to cleanse data feeding analytics or virtual care, then prove adoption in one program.",
        "questions": [
          {
            "id": "hc-dig-1",
          ...
          {
            "id": "hc-dig-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Data readiness for AI/analytics?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
    ...
    "personas": [
      {
        ...
        "shortDescription": "Wants trusted product data to avoid missed sales, inflated inventory, and inconsistent customer experiences.",
        "focusAreas": [
          "On-shelf and online availability",
          "Margin protection via clean assortments",
          "Consistent product experience across channels"
        ],
        "redPath": "Quantify margin and availability hits from duplicate or inconsistent SKUs, then pilot CODA on a key category to prove uplift.",
        "questions": [
          {
            "id": "retail-coo-1",
          ...
          {
            "id": "retail-coo-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves On-shelf and online availability?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs clean masters so replenishment, routing, and substitutions don’t create waste or delays.",
        "focusAreas": [
          "Accurate replenishment and allocations",
          "Duplicate prevention in DCs and stores",
          "Better substitutions for online orders"
        ],
        "redPath": "Connect data quality to delivery speed and waste reduction, then run a pilot on a high-volume region or DC.",
        "questions": [
          {
            "id": "retail-supply-1",
          ...
          {
            "id": "retail-supply-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Accurate replenishment and allocations?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs consistent product content so search, recommendations, and PDPs convert reliably.",
        "focusAreas": [
          "Search and recommendation accuracy",
          "Speed to publish new products",
          "Content consistency across locales"
        ],
        "redPath": "Show how CODA cleans and enriches content to lift conversion and reduce returns; pilot on one high-traffic category.",
        "questions": [
          {
            "id": "retail-ecom-1",
          ...
          {
            "id": "retail-ecom-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Search and recommendation accuracy?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs reliable masters so forecasts, allocations, and substitutes don’t misfire.",
        "focusAreas": [
          "Forecast accuracy",
          "Stock visibility across network",
          "Trusted substitutions"
        ],
        "redPath": "Tie clean masters to forecast accuracy and allocation wins, then pilot CODA on a volatile category.",
        "questions": [
          {
            "id": "retail-inv-1",
          ...
          {
            "id": "retail-inv-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Forecast accuracy?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs a way to enforce taxonomy, approvals, and integrations without slowing the business.",
        "focusAreas": [
          "Taxonomy and attribute governance",
          "Cross-system synchronization",
          "Low-friction adoption by business teams"
        ],
        "redPath": "Show how CODA automates validation and approvals across PIM, ERP, and eCommerce, then run a low-friction pilot with one brand.",
        "questions": [
          {
            "id": "retail-gov-1",
          ...
          {
            "id": "retail-gov-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Taxonomy and attribute governance?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
    ...
    "personas": [
      {
        ...
        "shortDescription": "Needs governed masters so analytics, onboarding, and regulatory reports align across systems.",
        "focusAreas": [
          "Golden records for customer and product",
          "Regulatory reporting accuracy",
          "Faster onboarding for new products"
        ],
        "redPath": "Connect CODA to reduced reconciliation effort and cleaner regulatory submissions, then pilot on a product line.",
        "questions": [
          {
            "id": "fs-cdo-1",
          ...
          {
            "id": "fs-cdo-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Golden records for customer and product?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs confidence that masters meet policy so audits, KYC, and AML controls are reliable.",
        "focusAreas": [
          "KYC/AML data completeness",
          "Audit-ready controls and lineage",
          "Reducing false positives and rework"
        ],
        "redPath": "Show how CODA enforces required attributes and lineage to cut false positives and audit prep time; pilot on onboarding.",
        "questions": [
          {
            "id": "fs-risk-1",
          ...
          {
            "id": "fs-risk-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves KYC/AML data completeness?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Wants clean masters so claims, servicing, and policy changes are handled fast without rework.",
        "focusAreas": [
          "First-time-right servicing",
          "Reducing rework and manual checks",
          "Better vendor and partner data"
        ],
        "redPath": "Tie data quality to cycle time and rework reduction, then pilot on one claim or servicing journey.",
        "questions": [
          {
            "id": "fs-ops-1",
          ...
          {
            "id": "fs-ops-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves First-time-right servicing?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs harmonized masters to reduce reconciliation effort and make funding decisions faster.",
        "focusAreas": [
          "Consolidated visibility across ledgers",
          "Working-capital unlocks from clean data",
          "Faster close and reporting"
        ],
        "redPath": "Quantify reconciliation effort and cash leakage from duplicates, then pilot CODA to prove faster close on one entity or product line.",
        "questions": [
          {
            "id": "fs-treasury-1",
          ...
          {
            "id": "fs-treasury-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Consolidated visibility across ledgers?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
      ...
      },
      {
        ...
        "shortDescription": "Needs consistent masters so onboarding, offers, and analytics work across channels without friction.",
        "focusAreas": [
          "Onboarding speed and accuracy",
          "Personalization with trusted data",
          "Integration reliability across channels"
        ],
        "redPath": "Show how CODA cleanses and standardizes data feeding onboarding and personalization, then pilot on one journey to prove adoption lift.",
        "questions": [
          {
            "id": "fs-digital-1",
          ...
          {
            "id": "fs-digital-4",
            "text": "To move forward, what would you need to see in a 4-week PoC to prove CODA improves Onboarding speed and accuracy?",
            "options": [
              "A baseline and target KPI with quantified before/after impact plus a path to scale.",
              "Qualitative stories from users and a few trend lines that point in the right direction.",
              "Any activity that shows we're working on it, even if the outcomes aren't measured yet."
